...
#define STRING_CONFIG_H_AUTHOR "(Isaac Franco, Ender-3 Pro SKR Mini E3 V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR Mini E3 V3.0"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -2.34 }
